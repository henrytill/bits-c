...
static struct Expr *varcreate(char const *name)
{
    struct Expr *e;
    size_t len;
...
static struct Expr *lamcreate(char const *param, struct Expr *body)
{
    struct Expr *e;
    size_t len;
...
static struct Expr *appcreate(struct Expr *fun, struct Expr *arg)
{
    struct Expr *e;
...
static int push(struct Stackitem **stack, int action, struct Expr *expr)
{
...
static void show(struct Expr *e, FILE *out)
{
